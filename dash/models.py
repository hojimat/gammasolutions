...
class Order(models.Model):
    ...
    origin_city = models.ForeignKey(City, on_delete=models.RESTRICT, related_name='orders_from', null=False, blank=True)
    ...
    destination_city = models.ForeignKey(City, on_delete=models.RESTRICT, related_name='orders_to', null=False, blank=True)
